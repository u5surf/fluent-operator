...
func Test_Cfg2ES(t *testing.T) {
	commonConfigTest(
		t,
		Fluentd.Spec.GlobalInputs,
		[]fluentdv1alpha1.ClusterOutput{FluentdclusterOutput2ES},
		"./expected/fluentd-namespaced-cfg-output-es.cfg",
	)
}
...
func Test_ClusterCfgInputTail(t *testing.T) {
	commonConfigTest(
		t,
		FluentdInputTail.Spec.GlobalInputs,
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutputTag},
		"./expected/fluentd-global-cfg-input-tail.cfg",
	)
}
...
func Test_ClusterCfgInputSample(t *testing.T) {
	commonConfigTest(
		t,
		FluentdInputSample.Spec.GlobalInputs,
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutputTag},
		"./expected/fluentd-global-cfg-input-sample.cfg",
	)
}
...
func Test_ClusterCfgInputMonitorAgent(t *testing.T) {
	commonConfigTest(
		t,
		FluentdInputMonitorAgent.Spec.GlobalInputs,
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutputTag},
		"./expected/fluentd-global-cfg-input-monitorAgent.cfg",
	)
}

func Test_ClusterCfgOutput2ES(t *testing.T) {
	sl := plugins.NewSecretLoader(nil, Fluentd.Namespace, logr.Logger{})
	commonClusterConfigTest(
		t,
		sl,
		[]fluentdv1alpha1.ClusterFilter{},
		[]fluentdv1alpha1.ClusterOutput{FluentdclusterOutput2ES},
		"./expected/fluentd-cluster-cfg-output-es.cfg",
	)
}
...
func Test_ClusterCfgOutput2ESDataStream(t *testing.T) {
	...
	commonClusterConfigTest(
		...
		sl,
		[]fluentdv1alpha1.ClusterFilter{},
		[]fluentdv1alpha1.ClusterOutput{FluentdclusterOutput2ESDataStream},
		"./expected/fluentd-cluster-cfg-output-es-data-stream.cfg",
	)
}
...
func Test_Cfg2OpenSearch(t *testing.T) {
	commonConfigTest(
		t,
		Fluentd.Spec.GlobalInputs,
		[]fluentdv1alpha1.ClusterOutput{FluentdclusterOutput2OpenSearch},
		"./expected/fluentd-namespaced-cfg-output-opensearch.cfg",
	)
}
...
func Test_ClusterCfgOutput2OpenSearch(t *testing.T) {
	...
	commonClusterConfigTest(
		...
		[]fluentdv1alpha1.ClusterFilter{},
		[]fluentdv1alpha1.ClusterOutput{FluentdclusterOutput2OpenSearch},
		"./expected/fluentd-cluster-cfg-output-opensearch.cfg",
	)
}
...
func Test_ClusterCfgOutput2Kafka(t *testing.T) {
	...
	commonClusterConfigTest(
		t,
		sl,
		[]fluentdv1alpha1.ClusterFilter{FluentdClusterFilter1},
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutput2kafka},
		"./expected/fluentd-cluster-cfg-output-kafka.cfg",
	)
}
...
func Test_ClusterCfgOutput2Loki(t *testing.T) {
	...
	commonClusterConfigTest(
		...
		sl,
		[]fluentdv1alpha1.ClusterFilter{FluentdClusterFilter1},
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutput2Loki},
		"./expected/fluentd-cluster-cfg-output-loki.cfg",
	)
}

func Test_MixedCfgs2ES(t *testing.T) {
	sl := plugins.NewSecretLoader(nil, Fluentd.Namespace, logr.Logger{})
	commonMixedConfigsTest(
		t,
		sl,
		[]fluentdv1alpha1.ClusterFilter{},
		[]fluentdv1alpha1.ClusterOutput{FluentdclusterOutput2ES},
		"./expected/fluentd-mixed-cfgs-output-es.cfg",
	)
}
...
func Test_ClusterCfgOutput2CloudWatch(t *testing.T) {
	...
	commonClusterConfigTest(
		...
		sl,
		[]fluentdv1alpha1.ClusterFilter{FluentdClusterFilter1},
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutput2CloudWatch},
		"./expected/fluentd-cluster-cfg-output-cloudwatch.cfg",
	)
}
...
func Test_ClusterCfgOutput2Datadog(t *testing.T) {
	...
	commonClusterConfigTest(
		...
		sl,
		[]fluentdv1alpha1.ClusterFilter{FluentdClusterFilter1},
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutput2Datadog},
		"./expected/fluentd-cluster-cfg-output-datadog.cfg",
	)
}
...
func Test_ClusterCfgOutput2Null(t *testing.T) {
	...
	commonClusterConfigTest(
		...
		sl,
		[]fluentdv1alpha1.ClusterFilter{FluentdClusterFilter1},
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutput2Null},
		"./expected/fluentd-cluster-cfg-output-null.cfg",
	)
}

func Test_MixedCfgCopy1(t *testing.T) {
	sl := NewSecretLoader(logr.Logger{}, lokiHttpCredentials, lokiTenantName)
	commonMixedCfgCopyTest(
		t,
		sl,
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutput2Loki},
		[]fluentdv1alpha1.Output{FluentdOutputMixedCopy1},
		[]fluentdv1alpha1.Filter{},
		"./expected/fluentd-mixed-cfgs-output-copy-1.cfg",
	)
}
...
func Test_MixedCfgCopy2(t *testing.T) {
	...
	commonMixedCfgCopyTest(
		t,
		sl,
		[]fluentdv1alpha1.ClusterOutput{},
		[]fluentdv1alpha1.Output{FluentdOutputMixedCopy2},
		[]fluentdv1alpha1.Filter{},
		"./expected/fluentd-mixed-cfgs-output-copy-2.cfg",
	)
}
...
func Test_MixedCfgCopy3(t *testing.T) {
	...
	commonMixedCfgCopyTest(
		...
		sl,
		[]fluentdv1alpha1.ClusterOutput{},
		[]fluentdv1alpha1.Output{FluentdOutputMixedCopy3},
		[]fluentdv1alpha1.Filter{},
		"./expected/fluentd-mixed-cfgs-output-copy-3.cfg",
	)
}
...
func Test_MixedCfgCopy4(t *testing.T) {
	...
	commonMixedCfgCopyTest(
		t,
		sl,
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutput2Loki1},
		[]fluentdv1alpha1.Output{FluentdOutput2ES1, FluentdOutput2ES2, FluentdOutput2ES3, FluentdOutput2ES4},
		[]fluentdv1alpha1.Filter{FluentdFilter},
		"./expected/fluentd-mixed-cfgs-output-copy-4.cfg",
	)
}
...
func Test_MixedCfgs2OpenSearch(t *testing.T) {
	...
	commonMixedConfigsTest(
		...
		[]fluentdv1alpha1.ClusterFilter{},
		[]fluentdv1alpha1.ClusterOutput{FluentdclusterOutput2OpenSearch},
		"./expected/fluentd-mixed-cfgs-output-opensearch.cfg",
	)
}
...
func Test_OutputWithBuffer(t *testing.T) {
	...
	commonClusterConfigTest(
		...
		sl,
		[]fluentdv1alpha1.ClusterFilter{FluentdClusterFilter1},
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutputBuffer},
		"./expected/fluentd-cluster-cfg-output-buffer-example.cfg",
	)
}
...
func Test_OutputWithMemoryBuffer(t *testing.T) {
	...
	commonClusterConfigTest(
		...
		sl,
		[]fluentdv1alpha1.ClusterFilter{FluentdClusterFilter1},
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutputMemoryBuffer},
		"./expected/fluentd-cluster-cfg-output-memory-buffer.cfg",
	)
}
...
func Test_RecordTransformer(t *testing.T) {
	...
	commonClusterConfigTest(
		t,
		sl,
		[]fluentdv1alpha1.ClusterFilter{FluentdClusterRecordTransformerFilter},
		[]fluentdv1alpha1.ClusterOutput{FluentdClusterOutputCluster},
		"./expected/fluentd-cluster-cfg-filter-recordTransformer.cfg",
	)
}

func commonClusterConfigTest(
	t *testing.T,
	...
	clustercfgRouter, err := psr.BuildCfgRouter(&FluentdClusterFluentdConfig1)
	g.Expect(err).NotTo(HaveOccurred())
	clustercfgResources, _ := psr.PatchAndFilterClusterLevelResources(
		sl,
		FluentdClusterFluentdConfig1.GetCfgId(),
		[]fluentdv1alpha1.ClusterInput{}, clusterFilters, clusterOutputs)
	err = psr.WithCfgResources(*clustercfgRouter.Label, clustercfgResources)
	g.Expect(err).NotTo(HaveOccurred())
	...
	for i := 0; i < maxRuntimes; i++ {
		...
		// fmt.Println(config)
		g.Expect(errs).NotTo(HaveOccurred())
		g.Expect(strings.TrimSpace(string(getExpectedCfg(file)))).To(Equal(config))
	}
}

func commonMixedConfigsTest(
	t *testing.T,
	sl plugins.SecretLoader,
	clusterFilters []fluentdv1alpha1.ClusterFilter,
	clusterOutputs []fluentdv1alpha1.ClusterOutput,
	...
	cfgResources, _ := psr.PatchAndFilterClusterLevelResources(
		sl,
		FluentdConfig1.GetCfgId(),
		[]fluentdv1alpha1.ClusterInput{},
		[]fluentdv1alpha1.ClusterFilter{},
		clusterOutputs)
	err = psr.WithCfgResources(*cfgRouter.Label, cfgResources)
	g.Expect(err).NotTo(HaveOccurred())
...
func commonMixedCfgCopyTest(
	t *testing.T,
	sl plugins.SecretLoader,
	clusterOutputsForCluster []fluentdv1alpha1.ClusterOutput,
	outputsForCluster []fluentdv1alpha1.Output,
	filter []fluentdv1alpha1.Filter,
	file string,
) {
	g := NewGomegaWithT(t)
	...
	cfgResources, _ := psr.PatchAndFilterNamespacedLevelResources(sl, FluentdConfig2.GetCfgId(), []fluentdv1alpha1.Input{}, filter, outputsForCluster)
	...
	for i := 0; i < maxRuntimes; i++ {
		...
		// fmt.Println(config)
		g.Expect(errs).NotTo(HaveOccurred())
		g.Expect(string(getExpectedCfg(file))).To(Equal(config))
	}
}

func commonConfigTest(
	t *testing.T,
	clusterInput []input.Input,
	clusterOutputs []fluentdv1alpha1.ClusterOutput,
	file string,
) {
	g := NewGomegaWithT(t)
	sl := plugins.NewSecretLoader(nil, Fluentd.Namespace, logr.Logger{})
	psr := fluentdv1alpha1.NewGlobalPluginResources("main")
	psr.CombineGlobalInputsPlugins(sl, clusterInput)
